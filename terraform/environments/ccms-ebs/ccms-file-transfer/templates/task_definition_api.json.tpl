[
  {
    ...
    "environment": [
      ...
      {
        "name": "ccms_api_feedback_url",
        "value": "${ccms_api_feedback_url}"
      },
      {
        "name": "ccms_api_owd_return_url",
        "value": "${ccms_api_owd_return_url}"
      },
      {
      ...
      {
        "name": "CCMS_api_AV_PORT",
        "value": "${ccms_api_av_port}"
      },
      {
        "name": "CCMS_api_AV_HOST",
        "value": "${ccms_api_av_host}"
      },
      {
      ...
      {
        "name": "CCMS_api_AV_SOCKETTIMEOUT",
        "value": "${ccms_api_av_socketTimeout}"
      },
      {
        "name": "CCMS_api_AV_SCANNERENABLED",
        "value": "${ccms_api_av_scannerEnabled}"
      },
      {
        "name": "CCMS_api_AUDITLOGIN_ENABLED",
        "value": "${ccms_api_auditLogin_enabled}"
      },
      {
