...
resource "aws_lakeformation_permissions" "emdi_fms_db" {
  ...
  permissions = ["DESCRIBE"]
  database {
    name = "serco_fms_curated_${local.environment_shorthand}"
  }
}
...
resource "aws_lakeformation_permissions" "emdi_fms_tables" {
  ...
  table {
    database_name = "serco_fms_curated_${local.environment_shorthand}"
    wildcard      = true
  }
}
...
resource "aws_lakeformation_permissions" "emdi_mdss_db" {
  ...
  permissions = ["DESCRIBE"]
  database {
    name = "staged_mdss_${local.environment_shorthand}"
  }
}
...
resource "aws_lakeformation_permissions" "emdi_mdss_tables" {
  ...
  permissions = ["SELECT", "DESCRIBE"]
  table {
    database_name = "staged_mdss_${local.environment_shorthand}"
    wildcard      = true
  }
}
