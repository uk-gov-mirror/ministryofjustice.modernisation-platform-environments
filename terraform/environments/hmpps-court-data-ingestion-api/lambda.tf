...
module "authorizer_lambda" {
  ...
  environment_variables = {
    SECRET_ID = local.environment_configuration[local.environment].secret_ingestion_api_auth_token_secret_arn
  ...
  policy_statements = {
    secrets = {
      ...
      resources = [module.secret_ingestion_api_auth_token_dev.secret_arn, module.secret_ingestion_api_auth_token_preprod.secret_arn, module.secret_ingestion_api_auth_token_prod.secret_arn]
    }
    kms = {
      effect    = "Allow"
